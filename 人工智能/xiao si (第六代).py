print('-------------------------本产品是邵宗贤独家制作,人工智能-小思2022年的第6代的产物-----------------------')
print('--小思网络叠加系统-11月份出版')
import json as j
import pyttsx3
import requests
import socket
...
print(j,pyttsx3,requests,socket,uuid)
print('你好,我是小思')
print('第6代人工智能')
...
line2 = '欢迎光临'
line3 = '我是小思同学'
line4 = '小思的第6代产品(six generation)'
line5 = '欢迎为您服务'
line6 = 'Hi,my name is Small thinking'
line7 = "Welcome to Small thinking world"
line8 = "Welcome to serve you"
engline.say(line1)
engline.say(line2)
engline.say(line3)
engline.say(line4)
